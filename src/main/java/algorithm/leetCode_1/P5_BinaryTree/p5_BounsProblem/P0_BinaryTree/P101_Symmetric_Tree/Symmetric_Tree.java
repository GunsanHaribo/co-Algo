package algorithm.leetCode_1.P5_BinaryTree.p5_BounsProblem.P0_BinaryTree.P101_Symmetric_Tree;
...
public class Symmetric_Tree {
    public static void main(String[] args) {
        ...
        TreeNode treeNode = TreeHelper.buildTree(new Integer[]{1,2,2,3,4,4,3});
//
