...
# 1. 이해
1. 미지(집합좁히기) : 달성가능한 최대 수익
2. 자료 : 주식의 당일 가격을 나타내는 prices 
3. 조건(집합s, 연립방정식) :
- 주식을 매도한 후에는 다음날 주식을 살 수 없습니다.
- 다시 구매하기 전에 주식을 매도해야합니다

# 2. 계획
- 시간 복잡도 상한(3억, 1억-8) :
- int overFlow 가능성 :
1. 유사한 문제 : DP에서 주식문제들 -> 주식 문제들의 유형이 뭐지?
2. 유사한 문제와 다른 부분 :
3. 문제를 다르게 진술하기 : 
...
- 다만, 일시적으로 max가 되었다고 해도, 전체적으로 max일까?
- 전체적으로 max이려면 어떻게 해야하지?
- 감을 못잡겠네 이문제, 이렇게 하면 100퍼 틀렸다고 할 것 같은데
- 이건 템플릿을 먼저보자