...
- 시간 복잡도 상한(3억, 1억^8) :2 * 10^9 보다 작다고하니 한번 돌아야될듯
- int overFlow 가능성(합을 구해야하는가) : 
1. 유사한 문제 : 
2. 유사한 문제와 다른 부분 :
3. 문제를 다르게 진술하기 : 
4. 선행(근접조건 제거) :
   - 왼쪽, 위쪽 합친값
   - 장애물이 있을 경우 건너 뜁니다. -> 1인 경우
...
https://leetcode.com/problems/unique-paths-ii/submissions/1832425676